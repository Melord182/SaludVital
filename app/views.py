...
from .serializers import EspecialidadSerializer, PacienteSerializer, MedicoSerializer, MedicamentoSerializer, ConsultaMedicaSerializer, TratamientoSerializer, RecetaMedicaSerializer, TipoSangreSerializer, UserSerializer
