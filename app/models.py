...
#Aquí crearemos la estructura de nuestra base de datos.
#Primero crearemos las tablas que no tienen Foreign Key.
#Se añadió la tabla de tipo de sangre para normalizar los datos.
#Se añadio la tabla Usuario para gestionar los usuarios del sistema.


#La tabla usuario servira para saber que se muestra luego en el frontend dependiendo de quien use el sistema.
